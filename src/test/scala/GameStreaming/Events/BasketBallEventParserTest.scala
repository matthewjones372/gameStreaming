  ...
  "BasketBallEventParser" should {
    "parse valid event examples" in {
      val validEventExamples: TableFor3[String, String, TeamScored] = Table(
        ...
        ("15 seconds of play, Team 1 scores 2 points", "0x781002", TeamScored(TwoPointer, Team1, expectedGameState(2, 0, 15))),
        ("30 seconds of play, Team 2 scores  3 points", "0xf0101f", TeamScored(ThreePointer, Team2, expectedGameState(2, 3, 30))),
        ("At 10:10 game time, Team 1 scores 1 point", "0x1310c8a1", TeamScored(OnePointer, Team1, expectedGameState(25, 20, 610))),
        ("At 22:23 game time, Team 1 scores 2 points", "0x29f981a2", TeamScored(TwoPointer, Team1, expectedGameState(48, 52, 1343))),
        ("At 38:30 game time, Team 2 scores 3 points", "0x48332327", TeamScored(ThreePointer, Team2, expectedGameState(100, 100, 2310)))
      )
